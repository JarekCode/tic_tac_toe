...
int user_get_movement_index(game* g) {
    ...
    while(flag == False) {
        printf("\nPlease enter index: ");
        index = my_get_char() - '0';
        flag = is_position_empty(g, index);
    }
...
int computer_get_movement_index(game* g) {
    ...
    while(flag == False) {
        if (g->intelligent_machine == False) {
            res = gen_num(0,9);
            flag = is_position_empty(g,res);

        } else if (g->intelligent_machine == True) {
...
int is_there_a_winner(game* g) {
    ...
    else if(g->board[0][0] == 'O' && g->board[0][1] == 'O' && g->board[0][2] == 'O') {
        res = 2;
    }
    else if(g->board[1][0] == 'X' && g->board[1][1] == 'X' && g->board[1][2] == 'X') {
        res = 1;
    }
    else if(g->board[1][0] == 'O' && g->board[1][1] == 'O' && g->board[1][2] == 'O') {
        res = 2;
    }
    else if(g->board[2][0] == 'X' && g->board[2][1] == 'X' && g->board[2][2] == 'X') {
        res = 1;
    }
    else if(g->board[2][0] == 'O' && g->board[2][1] == 'O' && g->board[2][2] == 'O') {
        res = 2;
    }

    else if(g->board[0][0] == 'X' && g->board[1][0] == 'X' && g->board[2][0] == 'X') {
        res = 1;
    }
    else if(g->board[0][0] == 'O' && g->board[1][0] == 'O' && g->board[2][0] == 'O') {
        res = 2;
    }
    else if(g->board[0][1] == 'X' && g->board[1][1] == 'X' && g->board[2][1] == 'X') {
        res = 1;
    }
    else if(g->board[0][1] == 'O' && g->board[1][1] == 'O' && g->board[2][1] == 'O') {
        res = 2;
    }
    else if(g->board[0][2] == 'X' && g->board[1][2] == 'X' && g->board[2][2] == 'X') {
        res = 1;
    }
    else if(g->board[0][2] == 'O' && g->board[1][2] == 'O' && g->board[2][2] == 'O') {
        res = 2;
    }

    else if(g->board[0][0] == 'X' && g->board[1][1] == 'X' && g->board[2][2] == 'X') {
        res = 1;
    }
    else if(g->board[0][0] == 'O' && g->board[1][1] == 'O' && g->board[2][2] == 'O') {
        res = 2;
    }
    else if(g->board[0][2] == 'X' && g->board[1][1] == 'X' && g->board[2][0] == 'X') {
        res = 1;
    }
    else if(g->board[0][2] == 'O' && g->board[1][1] == 'O' && g->board[2][0] == 'O') {
        res = 2;
    }
...
void process_movement(game* g, int pos) {
    ...
    boolean board = is_board_full(g);

    flag = is_there_a_winner(g);
    ...
    else if(flag == 0 && board == True) {
        g->status = 5;
    }
        //No need to check if board == False because the two statements will never be checked
        //as above the status will be set to 5
    else if(flag == 0 && board == False && g->status == 2) {
        g->status = 1;
    }
    else if(flag == 0 && board == False && g->status == 1) {
        g->status = 2;
    }
}
...
//------------------------------------
void update_avenue_states(game* g, int pos) {
    ...
    for (int i = 0; i < 8; i++) {
        if (((*g).avenue_positions[i][0] == pos) || ((*g).avenue_positions[i][1] == pos) ||
            ((*g).avenue_positions[i][2] == pos)) {
...
int get_position_points(game* g, int pos) {
    ...
    printf("\nCalculated Points: %d (At Pos %d)", res, pos);
...
int intelligent_selection(game* g) {
    ...
    for(int k = 0; k <= 8; k++) {
        ...
        if(g->board[row][col] == ' ') {
            number = get_position_points(g, k);
